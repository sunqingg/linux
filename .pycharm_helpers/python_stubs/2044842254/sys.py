...
executable = '/root/env/flask/bin/python3'

exec_prefix = '/root/env/flask'
...
path = [
    ...
    '/root/env/flask/lib64/python3.6/site-packages',
    '/root/env/flask/lib/python3.6/site-packages',
]
